      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          <div
            ...
            {/* Bubble only on medium+ screens */}
            <div className="hidden sm:flex absolute left-1/2 transform -translate-x-1/2 bg-gray-400 border-4 border-[#8245ec] w-12 h-12 sm:w-16 sm:h-16 rounded-full justify-center items-center z-10">
              <img
                src={edu.img}
                alt={edu.school}
            ...
            <div
              ...
              } ml-0 mr-0 sm:ml-4 sm:mr-4 transform transition-transform duration-300 hover:scale-105`}>
